...
const data = [
    ...
    ['^18.0.0', chalk.green('Active'), '2024-05-22', '2024-11-15', '2025-11-15'],
    ['^17.0.0', chalk.yellow('LTS'), '2023-11-08', '2024-05-08', '2025-05-15'],
    ['^16.0.0', chalk.yellow('LTS'), '2023-05-03', '2023-11-08', '2024-11-08'],
    ['^15.0.0', chalk.red('EOL'), '2022-11-18', '2023-05-03', '2024-05-18'],
